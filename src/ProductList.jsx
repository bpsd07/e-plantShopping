        ...
        <div>
            ...
            <div className="tag">
               ...
               <a   style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>BPSD's Plants</h3>
        ...
        <div className="product-grid">
            ...
            {item.plants.map((plant)=>
                <div className='product-card'>
                    ...
                    <p>{plant.cost}</p>
                   <button style={{ backgroundColor: alreadyInCart(plant.name) ? 'gray' : '#615EFC' }} disabled={alreadyInCart(plant.name)}onClick={() =>handleAddToCart({name: plant.name,cost: plant.cost, image: plant.image, })} className="product-button">{alreadyInCart(plant.name) ? 'Added to Cart' : 'Add to Cart'}</button>
                </div>)}
                 </div>
            </div>)}
        </div>
